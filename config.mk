...
CFLAGS   = -std=c99 -pedantic -Wall -Wno-deprecated-declarations -march=native -O3 -flto -pipe -fno-plt ${INCS} ${CPPFLAGS}
LDFLAGS  = ${LIBS} $(CFLAGS) -Wl,-O3,--sort-common,--as-needed,-z,now
